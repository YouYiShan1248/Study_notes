![[万字总结] 一文吃透 Webpack 核心原理](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/51a4951951604a05b12b40ab67ec6556~tplv-k3u1fbpfcp-zoom-crop-mark:3024:3024:3024:1702.awebp)
...
在这个数量级下，源码的阅读、分析、学习成本非常高，加上 webpack 官网语焉不详的文档，导致 webpack 的学习、上手成本极其高。为此，社区围绕着 Webpack 衍生出了各种手脚架，比如 [vue-cli](https://link.juejin.cn/?target=https%3A%2F%2Fcli.vuejs.org%2Fguide%2F)、[create-react-app](https://link.juejin.cn/?target=https%3A%2F%2Freactjs.org%2Fdocs%2Fcreate-a-new-react-app.html)，解决“用”的问题。
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ba579d352683432094302852a3037963~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
也就是将各种类型的资源，包括图片、css、js等，转译、组合、拼接、生成 JS 格式的 bundler 文件。[官网首页](https://link.juejin.cn/?target=https%3A%2F%2Fwebpack.js.org%2F)的动画很形象地表达了这一点：

![1d66a833-2841-4a8a-a91a-0da800fab306.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d1d3e3165499409e925c2832e0566df4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d8ce6474c85247829475ba1f2ec9a047~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/69c49d365f894fc19e42bce73d674b08~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

解释一下，构建阶段从入口文件开始：

1. 调用 `handleModuleCreate` ，根据文件类型构建 `module` 子类
2. 调用 [loader-runner](https://link.juejin.cn/?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Floader-runner) 仓库的 `runLoaders` 转译 `module` 内容，通常是从各类资源类型转译为 JavaScript 文本
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/16ff09e71aec484eb394696ccb9d60a0~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d9c9ca778cf545de9099c463723d8f1b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0a43a123b172418aba4019dbd79e064d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

从 a.js 模块中又解析到 c.js/d.js 依赖，于是再再继续调用 `module[a.js]` 的 `handleParseResult` ，再再递归上述流程：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0c22cb909cbd46cf98bbc64fdec5065f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae16969ecfe44bb8aef5f628fdd60f9b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/857866c0c60f44cfb8a87e67723c017b~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b4d576b67404c28b01b6390f60d4e3f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![image (3).png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/57de01d125a349f1ba58e56024063f85~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fe923c3d560241d38815d549786eab4f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/45520a6a81684fb99664f8d7a7089e6e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)

而 `compilation` 对象逐次触发：

![image (1).png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/de1f0d05a1274e6d86959b60a3d98742~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
- [compilation.addModule](https://link.juejin.cn/?target=https%3A%2F%2Fwebpack.js.org%2Fapi%2Fcompilation-object%2F%23addmodule) ：添加模块，可以在原有的 module 构建规则之外，添加自定义模块
- [compilation.emitAsset](https://link.juejin.cn/?target=https%3A%2F%2Fwebpack.js.org%2Fapi%2Fcompilation-object%2F%23emitasset)：直译是“提交资产”，功能可以理解将内容写入到特定路径
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1c11e6fc73724a2f9197676c538c8173~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
- 抓大放小：
  ...
  plugin 的关键是“钩子”，我建议战略上重视，战术上忽视！钩子毕竟是 webpack 的关键概念，是整个插件机制的根基，学习 webpack 根本不可能绕过钩子，但是相应的逻辑跳转实在太绕太不直观了，看代码的时候一直揪着这个点的话，复杂性会剧增，我的经验是：
...
- 保持好奇心：
  ...
  学习过程保持旺盛的好奇心和韧性，善于 & 敢于提出问题，然后基于源码和社区资料去总结出自己的答案，问题可能会很多，比如：
...
以 [webpack@5.26.3](https://link.juejin.cn/?target=mailto%3Awebpack%405.26.3) 为例，直接或间接继承自 `Module` (`webpack/lib/Module.js` 文件) 的子类有54个：

![module 体系.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/69b15fda723b4dacab9cd9ae9f51312a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
